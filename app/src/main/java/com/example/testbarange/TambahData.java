...
public class TambahData extends AppCompatActivity {
    ...
    // variabte fietds EditTéxf dan Button
...
// mengambil reférensi ke Firebase Database
    ...
    public void submitBrg(Barang brg){
        /* Berikut ini adatah kode yang digunakan untuk mengirimkan data ke
         * Firebase Reaitime Database dan juga kita set onSuccesgListener yang
         * berisi kode yang akan dijalankan ketika data berhasit ditambahkan
         */
